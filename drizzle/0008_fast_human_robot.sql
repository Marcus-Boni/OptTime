...
DO $$ BEGIN
 ALTER TABLE "app_release" ADD CONSTRAINT "app_release_author_id_user_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
