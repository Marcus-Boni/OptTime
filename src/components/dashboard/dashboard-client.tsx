...
function StatCard({
  ...
  return (
    <Card className="flex h-full flex-col justify-between border-border/50 bg-card/80 backdrop-blur">
            ...
            {loadingEntries ? (
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {recentEntries.map((entry) => (
                  <div
                    key={entry.id}
                    className="flex flex-col justify-between rounded-xl border border-border/60 bg-muted/10 p-3.5 transition-colors hover:border-brand-500/30 hover:bg-accent/40"
                  >
                    <div className="space-y-2">
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-border/40 pt-2 text-[10px] text-muted-foreground">
                      ...
                      <Badge
                        variant="secondary"
                        className={cn(
                          "h-4 rounded px-1.5 text-[9px] uppercase tracking-tighter",
                          entry.billable
