...
/**
 * Official Model Context Protocol (MCP) mark.
 *
 * Authored as a scalable SVG using currentColor so it seamlessly inherits
 * the styling of its container or text color classes.
 */
export function McpLogo({ className, title }: McpLogoProps) {
  return (
    <svg
